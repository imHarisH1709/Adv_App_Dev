...
// import BackgroundAnimation from './BackgrorundAnimation';

function HomePage() {
  return (
    <div>
      <Nav /><AccountCircleIcon/>
      <div className="home-container" style={{backgroundColor:"white",color:"black"}}>
        <img src={logo} width="110%" alt="Home" className="home-image10" />
        <div className="home-text">
        <h1 className='animate-charcter'> Welcome to Our </h1>
          <h2 className='animate'>Star Chess Academy</h2>
          <br/>
          <Link to="/Course"><button className='but'style={{fontFamily:'revert'}}>Join Course</button></Link>
          </div>
          <br/><br/>
          <div className='ch'>
          <p className='wh'>
