import '../Components/Join3.css';
import Nav from './Nav';
import logo from './../Components/Fundamental3.jpg'
...
const Join3 = () => {
  ...
  const courseData = {
    ...
    description:'Train your checkmating skills by solving these 100 mate in two puzzles!',
    contents: [
